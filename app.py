...
#         st.write(summary)
                         ...
                         ## 2 FOR NOTES AND QUESTIONS(FROM AI) GENERATION
...
# question_prompt = """You are an AI that generates related multiple choice questions based on the content provided.
# Please generate a list of related multiple choice questions based on the following text: """
...
# if st.button("Get Related Questions"):
#     transcript_text = extract_transcript_details(youtube_link)
#     if transcript_text:
#         related_questions = generate_gemini_content(transcript_text, question_prompt)
#         st.markdown("## Related Questions:")

#         # Clean and format related questions
...
#             st.markdown(f"- {question}")
                       ...
                       # FOR NOTES AND QUESTIONS(FROM DATASET) GENERATION
